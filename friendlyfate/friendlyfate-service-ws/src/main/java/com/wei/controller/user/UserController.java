...
@RestController
@RequestMapping("/api/friendly/user")
public class UserController {
    ...
    public ResponseEntity insertUser(@RequestBody UserModel model) {
     ...
     * @return
     */
    @RequestMapping(value = "/updatePassword", method = RequestMethod.DELETE)
