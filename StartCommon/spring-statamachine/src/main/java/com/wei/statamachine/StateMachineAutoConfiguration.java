...
public class StateMachineAutoConfiguration {
    ...
    public StateMachineModelFactory<String, String> modelFactory1() {
        ...
        return new UmlStateMachineModelFactory(new FileSystemResource(stateMachineProperties.getUmlFilePath1()));
    }
    ...
    public StateMachineModelFactory<String, String> modelFactory2() {
        ...
        return new UmlStateMachineModelFactory(new FileSystemResource(stateMachineProperties.getUmlFilePath2()));
    }
    ...
    public StateMachineModelFactory<String, String> modelFactory3() {
        ...
        return new UmlStateMachineModelFactory(new FileSystemResource(stateMachineProperties.getUmlFilePath3()));
    }
